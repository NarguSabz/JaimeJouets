       ...
       {$lookup:
         {
          ...
          if (resultat.length == 0) {
            ...
            collection.aggregate([
                ...
                res.render('pages/unProduit.ejs', { login: "", accueil: "", creationCompte: "", produit: "active", propos: "",produit: resultat[0],produitsDeMemeMarque:result, recherche:"", username: utilisateur})
                db.close();
            });
        };          
