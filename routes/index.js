      ...
      {$lookup:
        {
         ...
         res.render('pages/index.ejs', { login: "", accueil: "active", creationCompte: "", produit: "", propos: "",produits: resultat,marques:["Barbie","Fisher-Price","Hot Wheels","Lego","Vtech"], username: utilisateur });
